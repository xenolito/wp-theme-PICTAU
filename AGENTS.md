...
- **Pods:** para crear o modificar campos/grupos/pods, documentar en `.Codex/pods-playbook.json` y ejecutar via WP-CLI con `wp eval` + `pods_api()`.
...
├── .Codex/                  # Contexto y referencias para Codex
