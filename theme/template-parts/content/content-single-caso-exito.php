...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	//  no-bg-img
		...
		<div class="header-default-bg">
			<?php echo do_shortcode('[anim-bg color="#0251b3" origin="50%,50%" speed="3" size="1500"]'); ?>
			<?php echo do_shortcode('[anim-bg color="#ffff00" origin="70%,60%" speed="3" size="1500"]'); ?>
			<?php echo do_shortcode('[anim-bg color="#8AA738" origin="60%,75%" speed="3 size="1500""]'); ?>
		</div>
		<?php
	...
	?>
		...
		<div class="entry-header-content layout-site-width">
			...
			<h1 class="entry-title smaller" data-anim_any data-anim_any_whattoanim="chars" data-anim_any_animation="clippedFromBottom" data-anim_any_waitpageload="true" data-anim_any_duration="1" data-anim_any_stagger="0.025" >
			<?php
				echo $pods->field('titulo') . ' ' . $pods->field('company');
