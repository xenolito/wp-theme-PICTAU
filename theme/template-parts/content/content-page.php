...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<header class="entry-header has-bg no-bg-img">
		<div class="header-default-bg">
			<div class="header-canvas" data-webgldots_density="4" data-webgldots data-webgldots_target=".webgldots-container" data-webgldots_color="#ff6f00" data-webgldots_linecolor="#ff6f00" data-webgldots_speed="0.5" data-webgldots_dotsize="1.5">
