...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<header class="entry-header area has-bg only-img full-vh" data-parallax_header data-parallax_header_whattoanim=".is-bg">
		...
		<div class="entry-header-content">
			<?php
			the_title('<h1 class="entry-title" data-anim_any data-anim_any_whattoanim="chars" data-anim_any_animation="blurIn" data-anim_any_waitpageload="true" data-anim_any_duration="1" data-anim_any_stagger="0.2">', '</h1>');
			?>
			...
			<!--div class="cta" data-anim_any data-anim_any_duration="1" data-anim_any_delay="1">
				<div class="wp-block-buttons is-layout-flex wp-block-buttons-is-layout-flex">
					<div class="wp-block-button"><a href="<?php echo getLocalizedSlug('contacto') ?>" class="wp-block-button__link wp-element-button"><?php //echo pll__('Solicita información');
																																																																						?></a></div>
				</div>
			</div-->
