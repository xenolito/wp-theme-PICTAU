  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    const ModalForm = class {
      ...
      bindFoundLinks = () => {
        ...
        if (!documentTitle) {
          console.warn(`\u26A0\uFE0F No se encontr\xF3 un elemento <h1> para extraer el t\xEDtulo del documento. Las plantillas de tags como {{title}} no funcionar\xE1n correctamente.`);
          return;
        }
        const tags = {
