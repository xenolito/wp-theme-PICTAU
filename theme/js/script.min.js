(() => {
  ...
  var snap = function snap2(snapTo, value) {
    ...
    return _conditionalReturn(value, !isArray4 ? _roundModifier(snapTo) : _isFunction(snapTo) ? function(raw) {
      ...
      var x2 = parseFloat(is2D ? raw.x : raw), y2 = parseFloat(is2D ? raw.y : 0), min2 = _bigNum, closest3 = 0, i3 = snapTo.length, dx, dy;
      while (i3--) {
        if (is2D) {
          dx = snapTo[i3].x - x2;
          dy = snapTo[i3].y - y2;
  ...
  var _replaceRandom = function _replaceRandom2(value) {
    var prev = 0, s2 = "", i3, nums, end, isArray4;
    while (~(i3 = value.indexOf("random(", prev))) {
      end = value.indexOf(")", i3);
      isArray4 = value.charAt(i3 + 7) === "[";
      nums = value.substr(i3 + 7, end - i3 - 7).match(isArray4 ? _delimitedValueExp : _strictNumExp);
      s2 += value.substr(prev, i3 - prev) + random(isArray4 ? nums : +nums[0], isArray4 ? 0 : +nums[1], +nums[2] || 1e-5);
      prev = end + 1;
    }
  ...
  var interpolate = function interpolate2(start, end, progress, mutate) {
    ...
    if (!func) {
      var isString4 = _isString(start), master = {}, p2, i3, interpolators, l2, il;
  ...
  var _ticker = (function() {
    ...
    _self = {
      ...
      remove: function remove3(callback, i3) {
  ...
  var Animation = /* @__PURE__ */ (function() {
    ...
    _proto.reverse = function reverse3(from2, suppressEvents) {
  ...
  var _revertStyle = function _revertStyle2() {
    var props = this.props, target = this.target, style3 = target.style, cache2 = target._gsap, i3, p2;
    for (i3 = 0; i3 < props.length; i3 += 3) {
      props[i3 + 1] ? target[props[i3]] = props[i3 + 2] : props[i3 + 2] ? style3[props[i3]] = props[i3 + 2] : style3.removeProperty(props[i3].substr(0, 2) === "--" ? props[i3] : props[i3].replace(_capsExp, "-$1").toLowerCase());
    }
    if (this.tfm) {
      for (p2 in this.tfm) {
      ...
      i3 = _reverting2();
      if ((!i3 || !i3.isStart) && !style3[_transformProp]) {
  ...
  var _renderClearProps = function _renderClearProps2(ratio, data) {
    if (data.tween && data.tween._time === data.tween._dur) {
      var target = data.t, style3 = target.style, props = data.u, cache2 = target._gsap, prop, clearTransforms, i3;
  ...
  var _getVelocityProp = function _getVelocityProp2(value, minTimeRefresh, useDelta) {
    var v1 = value, v2 = value, t1 = _getTime(), t22 = t1, min2 = minTimeRefresh || 50, dropToZeroTime = Math.max(500, min2 * 3), update = function update2(value2, force) {
      var t3 = _getTime();
      if (force || t3 - t1 > min2) {
        v2 = v1;
        v1 = value2;
  ...
  var _setState = function _setState2(state) {
    if (state) {
      var style3 = state.t.style, l2 = state.length, i3 = 0, p2, value;
  ...
  var _getState = function _getState2(element) {
    var l2 = _stateProps.length, style3 = element.style, state = [], i3 = 0;
    for (; i3 < l2; i3++) {
      state.push(_stateProps[i3], style3[_stateProps[i3]]);
    }
    state.t = element;
    return state;
  };
  ...
  var debounce = (t3, n2) => {
    ...
    const mergeParms = (t4) => i3 && s2 ? i3(s2, t4) : t4;
    const flush = () => {
      if (c2 !== noop) {
        a2(mergeParms(e2) || e2);
      }
  ...
  var createOverflowUpdateSegment = (t3, n2) => {
    const [o2, s2] = n2;
    const { J: e2, tt: c2, K: r2, ot: l2, ft: i3, ht: a2, it: u2, ct: f2 } = t3;
    ...
    const observerCallback = (e3, c3) => {
      ...
      each(e3, ((o3) => {
        ...
        if (n2 && (b2 || !m2)) {
          ...
          each(h3, ((t4) => i3.add(t4)));
          each(p3, ((t4) => i3.add(t4)));
          g3 = g3 || v3;
        }
  ...
  var createSizeObserver = (t3, n2, o2) => {
    ...
    const onSizeChangedCallbackProxy = (t4) => {
      ...
      if (s2 && a3) {
        const n3 = e3 ? t4[0] : directionIsRTL(i3);
  ...
  var createStructureSetupObservers = (t3, n2, o2) => {
    ...
    let e2;
    let c2;
    const { J: r2, K: l2, nt: i3, lt: a2, ft: f2, _t: d2, ht: _2 } = t3;
  ...
  var createStructureSetup = (t3, n2) => {
    ...
    const [r2, l2, i3] = createStructureSetupElements(t3);
  ...
  var createScrollbarsSetupEvents = (t3, n2) => (o2, s2, e2, c2, r2, l2, i3) => {
    const { Ut: a2 } = o2;
    ...
    return runEachAndClear.bind(0, [on(a2, "pointerenter", (() => {
      ...
      S: false,
      $: true
    }), createRootClickStopPropagationEvents(a2, e2), createInteractiveScrollEvents(t3, c2, e2, o2, r2, n2, i3), f2]);
  };
  ...
  var OverlayScrollbars = (t3, n2, o2) => {
    ...
    const l2 = getPlugins();
    const i3 = isHTMLElement(t3);
    const a2 = i3 ? t3 : t3.target;
    ...
    if (n2 && !u2) {
      ...
      if (cancelInitialization(v2.Ft.it, e2().cancel, !i3 && t3.cancel)) {
        destroy(true);
        return x2;
      }
      v2.qt();
      ...
      h2("initialized", [x2]);
      v2.Nt(((t4, n3, o3) => {
        const { wt: s3, St: e3, vt: c3, Ht: r3, Lt: l3, It: i4, bt: a3, Tt: u4 } = t4;
        h2("updated", [x2, {
          updateHints: {
            sizeChanged: s3,
            directionChanged: e3,
  ...
  OverlayScrollbars.env = () => {
    const { k: t3, I: n2, A: o2, V: s2, Y: e2, H: c2, B: r2, U: l2, W: i3, q: a2, F: u2, G: f2, X: d2 } = getEnvironment();
    return assignDeep({}, {
      scrollbarsSize: t3,
  ...
  var ModalWP = class {
    ...
    setupFocusTrap = () => {
      this.modal.addEventListener("keydown", (e2) => {
        if (e2.code !== "Tab" || !this.modal.classList.contains("showing")) return;
    ...
    setupModalCloseLinks = () => {
      ...
      this.closeUI.addEventListener("keydown", (e2) => {
        if (e2.code !== "Space" && e2.code !== "Enter") return;
        e2.preventDefault();
        this.close();
      });
  ...
  var pushDataLayer = (payload) => {
    if (window.dataLayer && typeof window.dataLayer.push === "function") {
      window.dataLayer.push(payload);
    }
  };
  var pushGtagEvent = (eventName, params) => {
    if (typeof window.gtag === "function") {
      window.gtag("event", eventName, params);
    }
  };
  var buildCampaignData = (data) => {
    const campaign = {};
  ...
  window.addEventListener("load", () => {
    ...
    formContainers.forEach((formContainer) => {
      ...
      formContainer.addEventListener("wpcf7beforesubmit", (event) => {
        ...
        const data = Object.fromEntries(inputs.map((i3) => [i3.name, i3.value]));
  ...
  var syncAriaChecked = (iconEl, inputEl) => {
  ...
  // javascript/modules/modalContactForm7.js
  document.addEventListener("DOMContentLoaded", () => {
    const attributeId3 = "modalform";
    const modals = document.querySelectorAll(`[data-${attributeId3}]`);
    if (!modals.length) return;
    const ModalForm = class {
      constructor(targetDOMElement, config3 = {}) {
        const { modalform = "modal", inputtarget = false } = config3;
        this.modalContent = targetDOMElement;
        this.modalID = modalform;
        this.modal = new ModalWP_default(this.modalContent, {
          id: this.modalID,
          form: true
        });
        this.form = this.modal.popupContent.querySelector("form");
        if (!this.form) {
          console.warn(`\u26A0\uFE0F El modal "${this.modalID}" (data-modalform="${this.modalID}") no contiene ning\xFAn <form>. Comprueba que el formulario de Contact Form 7 referenciado dentro de este bloque exista y no haya sido borrado. Los triggers data-modalform_target="${this.modalID}" no abrir\xE1n este modal.`, this.modal.modal);
          return;
        }
        this.bindFoundLinks();
        return this;
      ...
      bindFoundLinks = () => {
        ...
        if (!h1) {
          console.warn(`\u26A0\uFE0F No se encontr\xF3 un elemento <h1> para extraer el t\xEDtulo del documento. Se usar\xE1 el t\xEDtulo de la p\xE1gina (document.title) como alternativa para las plantillas de tags como {{title}}.`);
        }
        const tags = {
          title: h1 ? h1.textContent : document.title
        };
        document.addEventListener("click", (e2) => {
          const link = e2.target.closest(`[data-modalform_target="${this.modalID}"]`);
          if (!link) return;
          e2.preventDefault();
    ...
    modals.forEach((modal, index) => {
      const config3 = getConfigByAtt(modal, attributeId3, true);
      modal.modal = new ModalForm(modal, config3);
    });
  });

  // javascript/modules/desktopMenuNavAnchor.js
  var parseCssPxValue = (value) => {
  ...
  var makeMainNavSubmenusLayoutAnchor = (headerContainerElement, visualPositioning, { safetyPadding = 16 } = {}) => {
...
Review your css class markup or html`);
  ...
  var makeMobileNav = (targetDom) => {
    ...
    const MobileMenuNav = class {
      ...
      resetMenuOnClick = () => {
        this.menu.querySelectorAll(".menu-item:not(.menu-item-has-children):not(.menu-item-is-shortcode)").forEach((el) => {
          el.addEventListener("click", () => {
            this.reset();
          });
        });
...
Review your css class markup or html`);
  ...
  var defaultEasing = (t3) => Math.min(1, 1.001 - Math.pow(2, -10 * t3));
  var Lenis = class {
    _isScrolling = false;
    ...
    onVirtualScroll = (data) => {
      ...
      const isTapToStop = this.options.syncTouch && isTouch2 && event.type === "touchstart" && isClickOrTap && !this.isStopped && !this.isLocked;
      if (isTapToStop) {
        this.reset();
        return;
      }
      ...
      if (!!composedPath.find(
        (node) => node instanceof HTMLElement && (typeof prevent2 === "function" && prevent2?.(node) || node.hasAttribute?.("data-lenis-prevent") || isTouch2 && node.hasAttribute?.("data-lenis-prevent-touch") || isWheel && node.hasAttribute?.("data-lenis-prevent-wheel") || this.options.allowNestedScroll && this.checkNestedScroll(node, { deltaX, deltaY }))
      ))
        return;
      ...
      const isSmooth = this.options.syncTouch && isTouch2 || this.options.smoothWheel && isWheel;
      if (!isSmooth) {
      ...
      const isTouchEnd = isTouch2 && event.type === "touchend";
  ...
  var _findMinimum = function _findMinimum2(values) {
    var l2 = values.length, min2 = _bigNum3, i3;
    for (i3 = 1; i3 < l2; i3 += 6) {
      +values[i3] < min2 && (min2 = +values[i3]);
    }
    return min2;
  };
  ...
  var CustomEase = /* @__PURE__ */ (function() {
    ...
    _proto.setData = function setData(data, config3) {
      config3 = config3 || {};
      data = data || "0,0,1,1";
      var values = data.match(_numExp2), closest3 = 1, points = [], lookup = [], precision = config3.precision || 1, fast = precision <= 1, l2, a1, a2, i3, inc, j2, point, prevPoint, p2;
      this.data = data;
  ...
  // javascript/modules/scrollTrigger_css-class.js
  gsapWithCSS.registerPlugin(ScrollTrigger2);
  gsapWithCSS.registerPlugin(CustomEase);
  document.addEventListener("DOMContentLoaded", () => {
    const attributeId3 = "classtrigger";
    const elementTrigger = document.querySelectorAll(`[data-${attributeId3}]`);
    if (!elementTrigger.length) return;
    const CssClassTrigger = class {
      constructor(elementTrigger2, config3 = {}) {
        const { repeat = true, delay = 0, duration = 1.5, stagger = 0.1, autoplay = true, triggerstart = null, markers = false, log = false, classtrigger = "" } = config3;
        this.elementTrigger = elementTrigger2;
    ...
    elementTrigger.forEach((elementTrigger2) => {
      const config3 = getConfigByAtt(elementTrigger2, "classtrigger", true);
      elementTrigger2.cssClassTrigger = new CssClassTrigger(elementTrigger2, config3);
    });
  });
  ...
  var t2 = function() {
    return t2 = Object.assign || function(t3) {
      for (var i3, n2 = 1, s2 = arguments.length; n2 < s2; n2++) for (var a2 in i3 = arguments[n2]) Object.prototype.hasOwnProperty.call(i3, a2) && (t3[a2] = i3[a2]);
      return t3;
  ...
  var i2 = (function() {
    function i3(i4, n2, s2) {
      ...
      this.endVal = n2, this.options = s2, this.version = "2.8.0", this.defaults = { startVal: 0, decimalPlaces: 0, duration: 2, useEasing: true, useGrouping: true, useIndianSeparators: false, smartEasingThreshold: 999, smartEasingAmount: 333, separator: ",", decimal: ".", prefix: "", suffix: "", enableScrollSpy: false, scrollSpyDelay: 200, scrollSpyOnce: false }, this.finalEndVal = null, this.useEasing = true, this.countDown = false, this.error = "", this.startVal = 0, this.paused = true, this.once = false, this.count = function(t3) {
        a2.startTime || (a2.startTime = t3);
        var i5 = t3 - a2.startTime;
        ...
        var i5, n3, s3, e2, o2 = t3 < 0 ? "-" : "";
        i5 = Math.abs(t3).toFixed(a2.options.decimalPlaces);
        var r2 = (i5 += "").split(".");
        ...
        return a2.options.numerals && a2.options.numerals.length && (n3 = n3.replace(/[0-9]/g, (function(t4) {
          return a2.options.numerals[+t4];
    ...
    return i3.prototype.handleScroll = function(t3) {
      if (t3 && window && !t3.once) {
        var i4 = window.innerHeight + window.scrollY, n2 = t3.el.getBoundingClientRect(), s2 = n2.top + window.pageYOffset, a2 = n2.top + n2.height + window.pageYOffset;
        a2 < i4 && a2 > window.scrollY && t3.paused ? (t3.paused = false, setTimeout((function() {
          return t3.start();
        }), t3.options.scrollSpyDelay), t3.options.scrollSpyOnce && (t3.once = true)) : (window.scrollY > a2 || s2 > i4) && !t3.paused && t3.reset();
      }
  ...
  document.addEventListener("DOMContentLoaded", () => {
    document.querySelectorAll(".pct-counter .pct-counter-number").forEach((el) => {
      const easingFn = function(t3, b2, c2, d2) {
        var ts = (t3 /= d2) * t3;
        var tc = ts * t3;
        return b2 + c2 * (tc + -3 * ts + 3 * t3);
      };
      const showPrefix = () => {
  ...
  (function() {
    ...
    function replaceWith() {
      ...
      var i3 = nodes.length;
      if (!parent2) return;
      if (!i3) parent2.removeChild(this);
      while (i3--) {
        var node = nodes[i3];
  ...
  function repositionAfterSplit(element, settings, scrollPos) {
    ...
    if (parent2) {
      if (nextSibling) parent2.insertBefore(element, nextSibling);
      else parent2.appendChild(element);
    }
    return lines;
  }
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    const HeaderAnimation = class {
      constructor(targetDOMElement, config3 = {}) {
        const {
          ...
          chainanim = false,
          nextanim = false,
          // next animation to play after this one: '.selector' or '.selector, 1.5' where 1.5 is seconds to wait after completion
          callback = false,
          // callback function to call after animation complete
          slideamount = 100,
          scalestart = 3,
          // blurIn: initial scale per character before animating to 1
          matchmedia = false,
          // disable animation if matchmedia query does not match (e.g. "min-width: 1024px")
          cyclecontentanim = "reveal",
          // cyclecontent/cyclecontentinline: name of the anim_any animation to reuse for each item's enter/exit
          cyclecontentrandom = false,
          // cyclecontent/cyclecontentinline: any non-empty value ('1', 'true', anything) randomizes the cycling order
          holdtime = 2,
          // cyclecontentinline: time each phrase stays fully visible before exiting
          cursorchar = "|",
          // typewriter: character used as the blinking cursor
          cursorblink = 0.5,
          // typewriter: seconds per blink half-cycle
          blankpause = 0.4,
          // typewriter inside cyclecontentinline: seconds the cursor keeps blinking alone at the start position after backspacing, before the next phrase starts typing
          fixedwords = 0,
          // cyclecontentinline: number of leading words (read from the first child only) extracted once into a static shared element before the target
          log = false
        } = config3;
        ...
        this.zoomBounceStartScale = animParam !== void 0 ? Number(animParam) : 0.35;
      ...
      setupAnimation = () => {
        ...
        if (this.nextanim) {
          ...
          const selector3 = parts[0].trim();
          this.nextAnimDelay = parts[1] ? Number(parts[1].trim()) : -1.5;
          this.nextToAnimate = document.querySelector(selector3);
        }
        if (this.callback) {
          ...
          this.timeLine.eventCallback("onComplete", () => {
            if (window[this.callbackFunc] === void 0) {
        ...
        if ((this.autoplay || isCycleContent) && !this.chainedTo) {
          this.trigger = ScrollTrigger2.create({
            ...
            animation: this.autoplay ? this.masterTimeLine ? this.masterTimeLine : this.timeLine : void 0,
            onEnter: isCycleContent && !this.autoplay ? () => this.hasStarted && this.timeLine.play() : void 0,
            onLeave: isCycleContent ? () => this.timeLine.pause() : void 0,
            onEnterBack: isCycleContent ? () => (this.autoplay || this.hasStarted) && this.timeLine.play() : void 0,
            onLeaveBack: (st2) => {
              if (isCycleContent) {
        ...
        if (this.nextanim && this.nextToAnimate) {
          ...
          const absolutePos = Math.max(1e-3, rawPos);
          this.timeLine.call(
            () => {
      ...
      setBlurInAnimation = () => {
        ...
        gsapWithCSS.set(this.header, { opacity: 1 });
        gsapWithCSS.set(elementsToAnim, { scale: this.scaleStart, opacity: 0 });
        elementsToAnim.forEach((elem) => {
          const offset = gsapWithCSS.utils.random(0, staggerWindow);
          this.timeLine.to(
            elem,
            {
              scale: 1,
      ...
      getCycleContentPreset = (name) => {
        const presets = {
          ...
          rotateX: {
            ...
            setup: (items) => gsapWithCSS.set(items, { transformPerspective: 800 }),
          ...
          clippedFromBottom: {
            ...
            setup: (items) => items.forEach((item) => {
      ...
      setCycleContent = () => {
        ...
        if (!preset) {
          console.warn(`anim_any cyclecontent: la animaci\xF3n "${this.cycleContentAnim}" no est\xE1 soportada para ciclar, se usa "reveal"`);
          preset = this.getCycleContentPreset("reveal");
        }
        gsapWithCSS.set(this.header, { opacity: 1, display: "grid" });
        gsapWithCSS.set(items, { gridRow: 1, gridColumn: 1 });
        ...
        preset.setup?.(items);
        gsapWithCSS.set(items, { ...preset.from, pointerEvents: "none" });
        const sequence = this.cycleContentRandom ? shuffle3(items) : items;
        ...
        const loopTimeLine = gsapWithCSS.timeline({ repeat: -1 });
        sequence.forEach((item, i3) => {
          const nextItem = sequence[(i3 + 1) % sequence.length];
      ...
      createCursorElement = () => {
        ...
        const blink = gsapWithCSS.to(cursor, {
          opacity: 1,
      ...
      tweenCycleInlineItem = (elements, preset, { entering, cursor, delay = 0 } = {}) => {
        if (preset.isTypewriter) {
          ...
          ordered.forEach((el, i3) => {
            const position = i3 === 0 ? delay : `+=${stagger}`;
            tl.set(
              el,
              {
        ...
        return gsapWithCSS.to(entering ? elements : [...elements].reverse(), {
      ...
      prepareFixedWordsHTML = (items) => {
        ...
        while (walker.nextNode()) {
          ...
          const matches2 = walker.currentNode.textContent.match(/\S+/g);
          if (matches2) totalWords += matches2.length;
        }
        const n2 = Math.min(this.fixedWords, totalWords);
        if (n2 < this.fixedWords) {
          console.warn(`anim_any cyclecontentinline: data-anim_any_fixedwords pide ${this.fixedWords} palabra(s) pero el primer hijo solo tiene ${totalWords}, se usan ${n2}`);
        }
        let fixedHTML = "";
        if (n2 > 0) {
          let wordCount = 0;
      ...
      excludeFixedWordsFromAnimation = (items, splitOf, splitType) => {
        const n2 = this.fixedWordsCount;
        let visibleFixedElements = [];
        items.forEach((item, i3) => {
          const itemWords = splitOf.get(item).words;
          const fixedItemWords = itemWords.splice(0, n2);
          const fixedChars = splitOf.get(item).chars.filter((c2) => fixedItemWords.some((w2) => w2.contains(c2)));
          splitOf.get(item).chars = splitOf.get(item).chars.filter((c2) => !fixedChars.includes(c2));
          const fixedElements = splitType === "words" ? fixedItemWords : fixedChars;
          if (i3 > 0 && fixedElements.length) {
            gsapWithCSS.set(fixedElements, { opacity: 0 });
          } else if (i3 === 0) {
      ...
      setCycleContentInline = () => {
        ...
        let preset = this.getCycleContentPreset(this.cycleContentAnim);
        if (!preset) {
          console.warn(`anim_any cyclecontentinline: la animaci\xF3n "${this.cycleContentAnim}" no est\xE1 soportada, se usa "reveal"`);
          preset = this.getCycleContentPreset("reveal");
        }
        gsapWithCSS.set(this.header, { opacity: 1, display: "inline-grid" });
        gsapWithCSS.set(items, { gridRow: 1, gridColumn: 1, textAlign: "left" });
        ...
        items.forEach((item) => gsapWithCSS.set(elementsOf(item), { transformOrigin: "center center", ...preset.from }));
        if (fixedWordsRevealElements.length) gsapWithCSS.set(fixedWordsRevealElements, { transformOrigin: "center center", ...preset.from });
      ...
      setTypewriter = () => {
        ...
        gsapWithCSS.set(this.header, { opacity: 1 });
        gsapWithCSS.set(elementsToAnim, { opacity: 0 });
        const { cursor, blink } = this.createCursorElement();
        elementsToAnim.forEach((char, i3) => {
          this.timeLine.set(
            char,
            {
              opacity: 1,
    ...
    const chainedTargets = /* @__PURE__ */ new Set();
    headerToAnim.forEach((header) => {
      const config3 = getConfigByAtt(header, attributeId3);
      if (!config3.nextanim) return;
      const selector3 = config3.nextanim.split(",")[0].trim();
      const target = document.querySelector(selector3);
      if (target && target.hasAttribute(`data-${attributeId3}`)) {
    ...
    headerToAnim.forEach((header) => {
      ...
      if (chainedTargets.has(header)) {
        config3.autoplay = "0";
        if (config3.delay === void 0) config3.delay = "0";
      }
  ...
  // javascript/modules/marquee.js
  var import_lodash = __toESM(require_lodash());
  document.addEventListener("DOMContentLoaded", () => {
    const attributeId3 = "marquee";
    const marqueeContainer = document.querySelectorAll(`[data-${attributeId3}]`);
    if (!marqueeContainer.length) return;
    const Marquee = class {
      constructor(marqueeContainer2, config3 = {}) {
        const { log = false, reverse: reverse3 = false, speed = 3e4 } = config3;
        this.marqueeContainer = marqueeContainer2;
        this.reverse = reverse3 ? true : false;
...
${this.items.length} found!`);
    ...
    marqueeContainer.forEach((marqueeContainer2) => {
      const config3 = getConfigByAtt(marqueeContainer2, attributeId3, false);
      marqueeContainer2.eventSelector = new Marquee(marqueeContainer2, config3);
    });
  });
  ...
  var isString3 = apply(typeOf, "string");
  ...
  function addClass2(elm, classes) {
    toggleClass(elm, isString3(classes) ? classes.split(" ") : classes, true);
  }
    ...
    slice(arguments, 1).forEach(function(source) {
      forOwn(source, function(value, key) {
        if (isArray3(value)) {
          ...
          object[key] = merge({}, isObject3(object[key]) ? object[key] : {}, value);
        } else {
          object[key] = value;
        }
      });
  ...
  function omit(object, keys2) {
    forEach(keys2 || ownKeys2(object), function(key) {
      delete object[key];
    });
  }
  ...
  function create(tag, attrs, parent2) {
    ...
    if (attrs) {
      isString3(attrs) ? addClass2(elm, attrs) : setAttribute(elm, attrs);
    }
  ...
  function unit(value) {
    return isString3(value) ? value : value ? value + "px" : "";
  }
  ...
  function EventInterface(Splide2) {
    ...
    function on2(events, callback) {
      binder.bind(bus, toArray4(events).join(" "), function(e2) {
        callback.apply(callback, isArray3(e2.detail) ? e2.detail : []);
      });
    }
    function emit(event) {
  ...
  function Media(Splide2, Components2, options) {
    ...
    function setup() {
      ...
      ownKeys2(breakpoints).sort(function(n2, m2) {
  ...
  function Slides(Splide2, Components2, options) {
    ...
    function filter(matcher) {
      return Slides2.filter(isFunction2(matcher) ? matcher : function(Slide2) {
        return isString3(matcher) ? matches(Slide2.slide, matcher) : includes(toArray4(matcher), Slide2.index);
      });
    }
  ...
  function Layout(Splide2, Components2, options) {
    ...
    function cssPadding(right) {
      ...
      return padding && unit(padding[prop] || (isObject3(padding) ? 0 : padding)) || "0px";
    }
  ...
  function Scroll(Splide2, Components2, options) {
    ...
    function easing(t3) {
      ...
      return easingFunc ? easingFunc(t3) : 1 - Math.pow(1 - t3, 4);
    }
    return {
      mount,
      destroy: clear2,
  ...
  function Drag(Splide2, Components2, options) {
    ...
    function shouldStart(e2) {
      ...
      var isObj = isObject3(thresholds);
  ...
  function Pagination(Splide2, Components2, options) {
    ...
    function createPagination() {
      ...
      for (var i3 = 0; i3 < max2; i3++) {
        var li = create("li", null, list);
        var button = create("button", {
          class: classes.page,
          type: "button"
        }, li);
        var controls = Slides2.getIn(i3).map(function(Slide2) {
          return Slide2.slide.id;
        });
        var text = !hasFocus() && perPage > 1 ? i18n.pageX : i18n.slideX;
        bind(button, "click", apply(onClick, i3));
        if (options.paginationKeyboard) {
          bind(button, "keydown", apply(onKeydown, i3));
        }
        setAttribute(li, ROLE, "presentation");
        setAttribute(button, ROLE, "tab");
        setAttribute(button, ARIA_CONTROLS, controls.join(" "));
        setAttribute(button, ARIA_LABEL, format(text, i3 + 1));
  ...
  var _Splide = /* @__PURE__ */ (function() {
    function _Splide2(target, options) {
      ...
      this._o = {};
      this._E = {};
      var root = isString3(target) ? query(document, target) : target;
...
\u{1F4E6} Group (outer)    \u2190 data-testimonials aqu\xED
  ...
  \u2514\u2500\u2500 \u{1F4E6} Group (slide N\u2026)`
      ...
      initSwiper = () => {
        ...
        try {
          ...
          console.warn("\u26D4\uFE0F testimonials-splide: Splide mount failed", e2.message);
          return;
        }
  ...
  // javascript/modules/hero_slider.js
  document.addEventListener("DOMContentLoaded", () => {
    const attributeId3 = "heroslider";
    ...
    const HeroSlider = class {
      constructor(container, config3 = {}) {
        ...
        this.delay = Math.round(Number(delay) * 1e3);
        ...
        this.fadeSpeed = Math.round(Number(fadespeed) * 1e3);
      ...
      setupDOM = () => {
        ...
        if (!splideList) {
          ...
          existingChildren.forEach((child2) => splideList.append(child2));
        }
    ...
    containers.forEach((container) => {
      const config3 = getConfigByAtt(container, attributeId3, true);
      container.heroSlider = new HeroSlider(container, config3);
    });
  });

  // javascript/modules/imgcompare.js
  document.addEventListener("DOMContentLoaded", () => {
    const attributeId3 = "imgcompare";
    const containers = document.querySelectorAll(`[data-${attributeId3}]`);
    if (!containers.length) return;
    ...
    const ImgCompare = class {
      ...
      buildDOM = () => {
        ...
        if (imgs.length < 2) {
          console.warn("\u26D4\uFE0F imgcompare: se necesitan 2 im\xE1genes en el bloque grupo");
          return;
        }
        ...
        handle.setAttribute("aria-label", "Comparador antes/despu\xE9s");
      ...
      updateX = (clientX) => {
        const rect2 = this.inner.getBoundingClientRect();
        const pct = Math.min(100, Math.max(0, (clientX - rect2.left) / rect2.width * 100));
      ...
      startShowoff = () => {
        ...
        const createTimeline = () => {
          this.tl = gsapWithCSS.timeline({ delay, repeat: -1, repeatDelay: 0.8, defaults: { onUpdate: setX } }).to(pos, { x: 72, duration: 1.3, ease: "power1.inOut" }).to(pos, { x: 20, duration: 2.4, ease: "power2.inOut" }, "+=0.35").to(pos, { x: 58, duration: 0.85, ease: "power2.out" }, "+=0.5").to(pos, { x: 33, duration: 1.8, ease: "power1.inOut" }, "+=0.2").to(pos, { x: 50, duration: 1.1, ease: "power2.inOut" }, "+=0.4");
        };
      ...
      bindEvents = () => {
        this.handle.addEventListener("pointerdown", (e2) => {
          this.isDragging = true;
          this.handle.setPointerCapture(e2.pointerId);
          document.body.style.touchAction = "none";
          this.updateX(e2.clientX);
        });
        this.handle.addEventListener("pointermove", (e2) => {
    ...
    containers.forEach((container) => {
      const config3 = getConfigByAtt(container, attributeId3, true);
      container.imgCompare = new ImgCompare(container, config3);
    });
  });
  ...
  var ScrollToPlugin = {
    ...
    kill: function kill(property) {
      var both = property === "scrollTo", i3 = this._props.indexOf(property);
  ...
  // javascript/modules/style-header-by-section.js
  gsapWithCSS.registerPlugin(ScrollTrigger2);
  document.addEventListener("DOMContentLoaded", () => {
  ...
  // javascript/modules/video-trigger.js
  document.addEventListener("DOMContentLoaded", () => {
    ...
    videoTriggers.forEach((videoTrigger) => {
      ...
      videoTrigger.addEventListener("click", (e2) => {
  ...
  // javascript/modules/event_selector.js
  document.addEventListener("DOMContentLoaded", () => {
    const attributeId3 = "event_selector";
    const eventsContainer = document.querySelectorAll(`[data-${attributeId3}]`);
    if (!eventsContainer.length) return;
    const EventSelector = class {
      constructor(eventContainer, config3 = {}) {
        const { log = false, form = false, formfieldtarget = false, nothingselectedmsg = false } = config3;
...
Please check the shortcode's attribute [events-by-cat form_nothingselected_msg="<css class name>"] for linking it to the event selector`
      ...
      setupUI = () => {
        ...
        this.events.forEach((event) => {
          ...
          event.addEventListener("click", (e2) => {
            this.add(event);
            this.updateForm();
          });
        });
      ...
      clean = (event) => {
        this.enrolled = this.enrolled.filter((e2) => e2 !== event);
      };
      updateForm = () => {
        const enrolledSorted = [...this.enrolled].sort((a2, b2) => {
          const da = a2.getAttribute("data-event_date") || "";
          const db = b2.getAttribute("data-event_date") || "";
          const ta = Date.parse(da.replace(" ", "T"));
          const tb = Date.parse(db.replace(" ", "T"));
          if (isNaN(ta) && isNaN(tb)) return a2.data.name.localeCompare(b2.data.name);
          if (isNaN(ta)) return 1;
          if (isNaN(tb)) return -1;
          if (ta === tb) return a2.data.name.localeCompare(b2.data.name);
          return ta - tb;
        });
        const dataToSend = enrolledSorted.map((e2) => `${e2.data.day} / ${e2.data.time} -- ${e2.data.name} \r
--------------\r
 `);
      ...
      updateEnrolledFormUI = () => {
        ...
        const enrolledTemp = [...this.enrolled].sort((a2, b2) => {
          const ta = Date.parse((a2.getAttribute("data-event_date") || "").replace(" ", "T"));
          const tb = Date.parse((b2.getAttribute("data-event_date") || "").replace(" ", "T"));
          if (isNaN(ta) && isNaN(tb)) return a2.data.name.localeCompare(b2.data.name);
          if (isNaN(ta)) return 1;
          if (isNaN(tb)) return -1;
          if (ta === tb) return a2.data.name.localeCompare(b2.data.name);
    ...
    eventsContainer.forEach((eventContainer) => {
      const config3 = getConfigByAtt(eventContainer, attributeId3, true);
      eventContainer.eventSelector = new EventSelector(eventContainer, config3);
    });
  });

  // javascript/modules/webgl_grid_background.js
  var import_throttleit = __toESM(require_throttleit());
  ...
  var hexToRgb = (hex) => {
    ...
    if (hex.length !== 6) {
      throw new Error("Formato hexadecimal inv\xE1lido");
    }
  ...
  document.addEventListener("DOMContentLoaded", () => {
    const attributeId3 = "webglgrid";
    const backgroundContainer = document.querySelectorAll(`[data-${attributeId3}]`);
    if (!backgroundContainer.length) return;
    const BackgroundGL = class {
      constructor(bgContainer, config3 = {}) {
        const { triggerstart = false, log = false, target = false, square = 6, spacing = 16, color = "156,217,249", opacity = 0.15, cssclass = false, markers = false } = config3;
        ...
        this.color = isHexColor(color) ? hexToRgb(color) : {
      ...
      drawGrid = () => {
        ...
        for (let y2 = 0; y2 < this.canvas.height; y2 += this.spacing) {
          for (let x2 = 0; x2 < this.canvas.width; x2 += this.spacing) {
            const alpha = Math.random() * this.maxOpacity;
            this.ctx.fillStyle = `rgba(${this.color.r}, ${this.color.g}, ${this.color.b}, ${alpha})`;
            this.ctx.fillRect(x2, y2, this.square, this.square);
          }
        }
      };
      getSize = () => {
      ...
      addListeners = () => {
        this.throttledResizeCallback = (0, import_throttleit.default)(this.resizeUpdate, 300);
        this.resizeObserver();
      };
      resizeUpdate = () => {
        this.size = this.getSize();
    ...
    backgroundContainer.forEach((bgContainer) => {
      const config3 = getConfigByAtt(bgContainer, attributeId3, false);
      bgContainer.bgWebGL = new BackgroundGL(bgContainer, config3);
    });
  });
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    const ImageMask = class {
      constructor(container, config3 = {}) {
        ...
        this.phases = Array.from({ length: this.n }, (_2, i3) => i3 / this.n * Math.PI * 4);
      ...
      blobPts = (r2, t3) => {
        ...
        return Array.from({ length: n2 }, (_2, i3) => {
          const angle = i3 / n2 * Math.PI * 2 - Math.PI / 2;
          const delta = -(intensity * baseR * amplitudes[i3]) * (1 + Math.sin(t3 * speed + phases[i3])) / 2;
          const ri = r2 + delta;
      ...
      toPath = (pts) => {
        ...
        const k2 = 1 / 6;
        const c1x = (i3) => pts[i3].x + (pts[(i3 + 1) % len].x - pts[(i3 - 1 + len) % len].x) * k2;
        const c1y = (i3) => pts[i3].y + (pts[(i3 + 1) % len].y - pts[(i3 - 1 + len) % len].y) * k2;
        const c2x = (i3) => pts[(i3 + 1) % len].x - (pts[(i3 + 2) % len].x - pts[i3].x) * k2;
        const c2y = (i3) => pts[(i3 + 1) % len].y - (pts[(i3 + 2) % len].y - pts[i3].y) * k2;
        let d2 = `M${pts[0].x.toFixed(2)} ${pts[0].y.toFixed(2)}`;
        for (let i3 = 0; i3 < len; i3++) {
          const nx = pts[(i3 + 1) % len];
          d2 += ` C${c1x(i3).toFixed(2)} ${c1y(i3).toFixed(2)} ${c2x(i3).toFixed(2)} ${c2y(i3).toFixed(2)} ${nx.x.toFixed(2)} ${nx.y.toFixed(2)}`;
        }
        return d2 + "Z";
      };
      ...
      render = (t3) => {
        ...
        this.clipShape.setAttribute("d", this.toPath(this.blobPts(baseR, t3)));
        this.ringEls[0].setAttribute("d", this.toPath(this.blobPts(baseR + ring1Width / 2, t3)));
        this.ringEls[1].setAttribute("d", this.toPath(this.blobPts(baseR + ring1Width + gap + ring2Width / 2, t3)));
      };
  ...
  var StickySection = class {
    ...
    buildLayerAnimation = (layers, gap = 0) => {
      ...
      layers.forEach((layer, i3) => layer.setAttribute("data-st-index", i3 + 1));
      ...
      const segStarts = [];
      let cursor = 0;
      layers.forEach((_2, i3) => {
        segStarts.push(cursor);
        if (i3 < n2 - 1) cursor += slotSizes[i3] + gaps[i3];
      });
      layers.forEach((layer, i3) => {
        const segStart = segStarts[i3];
        const segSize = slotSizes[i3];
  ...
  // javascript/modules/catalogMenu.js
  ...
  document.addEventListener("DOMContentLoaded", () => {
    checkIfTouchDevice();
    console_signature_default({ url: "https://www.thinkingmark.com" });
    setScrollBars();
    initCatalogMenu();
    if (!document.querySelector("#masthead")) return;
  ...
  var sliderInit = window.sliderInit = (index, splide) => {
  ...
  var activateHeroSlide = (el) => {
    el.querySelector("h1[data-anim_any]")?.headerAnimation?.play();
    revealSlideCover(el);
  };
  var revealSlideCover = (activeSlide) => {
  ...
  var setupAutoHideHeader = () => {
    ...
    ScrollTrigger2.create({
      ...
      onUpdate: (self2) => {
        if (window.pictauMobileNav.showing && self2.direction !== -1) window.pictauMobileNav.reset();
