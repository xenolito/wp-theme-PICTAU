    ...
    const HeaderAnimation = class {
      constructor(targetDOMElement, config3 = {}) {
        const {
          ...
          // cyclecontent: name of the anim_any animation to reuse for each item's enter/exit
          cyclecontentrandom = false,
          // cyclecontent: any non-empty value ('1', 'true', anything) randomizes the cycling order
          log = false
        } = config3;
