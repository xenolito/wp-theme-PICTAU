...
Review your css class markup or html`);
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    const HeaderAnimation = class {
      ...
      setupAnimation = () => {
        ...
        if (this.nextanim && this.nextToAnimate) {
          ...
          const absolutePos = rawPos > 1e-3 ? rawPos : tlDuration;
          this.timeLine.call(
            () => {
    ...
    headerToAnim.forEach((header) => {
      const config3 = getConfigByAtt(header, attributeId3);
      if (chainedTargets.has(header)) config3.autoplay = "0";
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    const HeroSlider = class {
      constructor(container, config3 = {}) {
        const { delay = "5000", draggable = "yes", arrows = "no", bullets = "yes", customarrows = false, callback = false, transition = "slide", fadespeed = "0.8", pauseonfocus = "no" } = config3;
