...
Review your css class markup or html`
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    const HeaderAnimation = class {
      ...
      setSlideTo = (dir) => {
        ...
        if (this.log)
          console.log("animation", this.animation, "dir", dir, "startPosition", startPosition);
  ...
  function onTouchMove(event2) {
    ...
    if (e2.type === "touchmove") {
      targetTouch = [...e2.changedTouches].filter((t3) => t3.identifier === data.touchId)[0];
  ...
  // javascript/modules/swiper-images.js
  document.addEventListener("DOMContentLoaded", () => {
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    if (!menuStylerSections.length || !header)
      return;
