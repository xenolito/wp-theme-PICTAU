...
<section id="primary">
	<main id="main">
		<article>
			...
			<header class="entry-header has-bg <?php echo $has_featured_img_cssClass ?>">
				...
				?>
					...
					<div class="entry-header-content layout-site-width">
						<?php
						echo '<h1 class="page-title">Sala Demo</h1>';
						...
						<div class="header-subtitle">
							<div class="left-border"></div>
									...
									<?php echo __('Descubre a través de estos interesantes seminarios online cómo optimizar la gestión y productividad de tu empresa.','pictau') ?>
			...
			while ( have_posts() ) :
				the_post();
				get_template_part( 'template-parts/content/content', 'excerpt-webinar-ondemand' );
